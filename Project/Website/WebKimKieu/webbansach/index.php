...
<body>    
    ...
    <div id="wrapper">  
        ...
        <div id="header">            
            <div id="lg-header">                
                <h1><img src= "./img/logoheader.jpg"></h1>            
            </div>            
            <div id="bg-header">
			<h1><img src= "./img/bg-header"></h1>
				 </div>           
            <div id="menu-header">                
	...
	<div id= "footer">
		<div id="footer1">
		  <div class="box"> 
		    <div align="center"><img src= "./img/logo1.jpg" height="auto" width="40%"><br>
	        </div>
		  ...
		  <div class="box3">
			...
			<p>Địa chỉ: Bình Thạnh, TPHCM</p>
				<p>Điện thoại: 0339317215</p>
				<p>Email: ntkkieuuuu@gmail.com</p>
		  </div>
		...
		<div id="footer2">
			<span></span><a href="#"> Designed by Kim Kiều</a>
		</div>
	</div>
	</div>
